...
class Pre_Order_For_Restropress_Admin
{
	...
	public function pre_order($general_settings)
	{
		...
		$general_settings['pre_order']['enable_printing'] = array(
			...
			'desc' => __('Check this box to enable pre order settings.', 'restropress'),
			'type' => 'checkbox',
		);

		$general_settings['pre_order']['delivery_date'] = array(
			'id' => 'po_delivery_date_text',
			'name'    => __('  Delivery Date Text ', 'restropress'),
			'desc' => __('Enter delivery date  text of product', 'restropress'),
			'type' => 'text',
		);
		$general_settings['pre_order']['pickup_date'] = array(
			'id' => 'po_pickup_date_text',
			'name'    => __('  Pickup Date Text ', 'restropress'),
			'desc' => __('Enter pickup date text  of product', 'restropress'),
			'type' => 'text',
		);
		$general_settings['pre_order']['days'] = array(
			'id' => 'po_days',
			'name'    => __('  NO. of days for pre-order ', 'restropress'),
			'desc' => __('Enter number of days for pre-order of a product', 'restropress'),
			'type' => 'number',
		);
	...
	{
		$section['pre_order'] = __('Pre Order', 'rpress-preorder');
		return $section;
	}
